...
*   =================================
*   创 建 者 ：Memoyu
*   创建日期 ：2021-01-03 14:43:21
*   邮箱     ：mmy6076@outlook.com
*   功能描述 ：
***************************************************************************/
using Autofac;
using Sr.Manager.ToolKits.Base.Dependency;
using System;
using System.Linq;
...
namespace Sr.Manager.WebApi.Modules
{
    public class DependencyModule : Autofac.Module
    {
        ...
        {
            Assembly[] currentAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(r => r.FullName.Contains("Sr.Manager")).ToArray();
