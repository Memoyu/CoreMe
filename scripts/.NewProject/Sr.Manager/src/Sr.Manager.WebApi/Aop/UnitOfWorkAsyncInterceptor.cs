...
*   命名空间 ：Sr.Manager.WebApi.Aop
*   文件名称 ：UnitOfWorkAsyncInterceptor.cs
*   =================================
*   创 建 者 ：Memoyu
*   创建日期 ：2021-01-03 11:33:42
*   邮箱     ：mmy6076@outlook.com
*   功能描述 ：
***************************************************************************/
using Castle.DynamicProxy;
using FreeSql;
using Sr.Manager.Application.Contracts.Attributes;
using Microsoft.Extensions.Logging;
using System.Linq;
using System.Threading.Tasks;

namespace Sr.Manager.WebApi.Aop
{
