...
namespace CoreMe.Infrastructure.Persistence.Cache;

public class EasyCachingRedisDistributedCache : IDistributedCache
{
    // KEYS[1] = = key
    ...
    public EasyCachingRedisDistributedCache(IRedisCachingProvider provider)
    {
        _provider = provider;
    }
