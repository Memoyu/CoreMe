...
*   命名空间 ： Memoyu.Core.Application.Contracts.Base
...
using Memoyu.Core.Application.Contracts.Filter;
using Memoyu.Core.Domain.Base;

namespace Memoyu.Core.Application.Contracts.Base
{
    public class DomainReflexUtil
    {
        ...
        public static List<PermissionDefinition> GetAssemblyPermissionAttributes()
        {
            ...
            //获取WebApi程序集
            List<Type> assembly = Assembly.Load("Memoyu.Mbill.WebApi").GetTypes().AsEnumerable()
