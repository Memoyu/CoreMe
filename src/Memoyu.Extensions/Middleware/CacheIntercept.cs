...
*   命名空间 ：Memoyu.Extensions.Aop
*   文件名称 ：AopCacheIntercept.cs
*   =================================
*   创 建 者 ：Memoyu
*   创建日期 ：2020-12-27 20:46:30
*   邮箱     ：mmy6076@outlook.com
*   功能描述 ：
***************************************************************************/
using Castle.DynamicProxy;
using Memoyu.Core.Aop.Attributes;
using Memoyu.Core.Common;
...
namespace Memoyu.Extensions.Middleware
{
    public class CacheIntercept : IInterceptor
    {
        ...
        public CacheIntercept(IConfiguration configuration)
        {
